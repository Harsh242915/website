...
import { ArrowRight, ChevronDown, CheckCircle, ShieldAlert, Sparkles, Activity, ShieldCheck, Zap } from 'lucide-react';
...
export function Hero({ onOpenArchitecture }: HeroProps) {
  ...
  // Realistic edge ping simulation
  useEffect(() => {
  ...
  return (
    <section id="hero-section" className="relative w-full max-w-[1360px] mx-auto px-4 sm:px-8 pt-14 sm:pt-18 pb-16 grid-pattern">
      ...
      <div className="relative flex flex-col gap-7 max-w-5xl">
        {/* Simple Badge */}
        <div className="inline-flex items-center gap-2 font-mono text-xs text-[#d8ff38]">
          ...
          <span className="text-[#9c93a8] font-mono">MODERN WEB APPS &amp; CUSTOM PLATFORMS</span>
        </div>

        {/* Clear Headline in Layman Terms */}
        <h1 className="font-display font-black text-4xl sm:text-6xl lg:text-7xl text-white tracking-tight leading-[1.06] uppercase">
          We build high-quality web apps and platforms that{' '}
        ...
        {/* Clear Subtitle without buzzwords */}
        <p className="text-lg sm:text-xl text-[#9c93a8] max-w-3xl leading-relaxed font-normal">
          Launchdrift is a specialized engineering studio. We help founders and growing businesses turn their product ideas into fast, reliable software with clean design, rock-solid security, and transparent timelines.
        </p>
        ...
        <div className="flex flex-wrap items-center gap-4 pt-2">
          ...
          <div className="flex items-center gap-2 text-xs font-mono text-[#9c93a8] sm:ml-2">
            <span className="w-2.5 h-2.5 rounded-full bg-[#d8ff38] animate-pulse"></span>
            <span>Direct Collaboration • 100% Code Ownership</span>
          </div>
        </div>
      </div>

      {/* Real-World Value Pillars */}
      <div className="mt-14 pt-8 border-t border-[#2f273c] grid grid-cols-2 md:grid-cols-4 gap-6 font-mono">
        {/* Metric 1 */}
        <div
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-[11px] text-[#9c93a8] uppercase">LOADING SPEED</span>
        ...
        <div className="flex flex-col gap-1 p-3 rounded-lg border border-transparent">
          <div className="flex items-center justify-between">
            <span className="text-[11px] text-[#9c93a8] uppercase">RELIABILITY</span>
            <CheckCircle className="w-3 h-3 text-[#d8ff38]" />
          </div>
          <span className="text-2xl font-bold text-white tracking-tight">FULLY TESTED</span>
          <span className="text-[11px] text-[#9c93a8]">Works seamlessly across devices</span>
        </div>

        {/* Metric 3 */}
        <div className="flex flex-col gap-1 p-3 rounded-lg border border-transparent">
          <div className="flex items-center justify-between">
            <span className="text-[11px] text-[#9c93a8] uppercase">CLEAN CODE</span>
            <Sparkles className="w-3 h-3 text-[#ff6b35]" />
          </div>
          <span className="text-2xl font-bold text-[#ff6b35] tracking-tight">EASY TO SCALE</span>
          <span className="text-[11px] text-[#9c93a8]">Built so your team can expand it</span>
        </div>

        {/* Metric 4 */}
        <div className="flex flex-col gap-1 p-3 rounded-lg border border-transparent">
          <div className="flex items-center justify-between">
            <span className="text-[11px] text-[#9c93a8] uppercase">POST-LAUNCH</span>
            <ShieldCheck className="w-3 h-3 text-[#38bdf8]" />
          </div>
          <span className="text-2xl font-bold text-white tracking-tight">30-DAY SUPPORT</span>
          <span className="text-[11px] text-[#9c93a8]">Guaranteed warranty &amp; bug fixes</span>
        </div>
      </div>
    </section>
  );
